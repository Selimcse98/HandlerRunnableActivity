...
public class HandlerMessagesActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Bundle obtainBundle = getIntent().getExtras();
		String gotString = obtainBundle.getString("string");

		int gotInt = obtainBundle.getInt("intValue", -1);
		if(gotString!=null || gotInt!=-1)
		...
		backButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HandlerMessagesActivity.this,HandlerRunnableActivity.class);
				i.putExtra("string","Back to parent");
				i.putExtra("intValue",999);
				startActivity(i);
				finish();
			}
		});
